...
/* package lispy-0.1.0.0 */
#ifndef VERSION_lispy
#define VERSION_lispy "0.1.0.0"
#endif /* VERSION_lispy */
#ifndef MIN_VERSION_lispy
#define MIN_VERSION_lispy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lispy */
...
#define CURRENT_PACKAGE_KEY "lispy-0.1.0.0-JCYSbtIImDtKOmDe78XXI1"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "lispy-0.1.0.0-JCYSbtIImDtKOmDe78XXI1"
